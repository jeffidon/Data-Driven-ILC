...
disp(['Note: unstable results (NaN) are treated as 1E3; and no correlation is calculated in such cases.']);
disp(['Binary Dist: robust ave = ' num2str(mean(MC_robust)) ', std = ' num2str(std(MC_robust)) ...
      '; nominal ave = ' num2str(mean(MC_nominal)) ', std = ' num2str(std(MC_nominal))]);
